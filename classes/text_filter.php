...
if (class_exists('\core_filters\text_filter')) {
    class_alias('\core_filters\text_filter', 'filter_syntaxhighlighter_base_text_filter');
} else {
    class_alias('\moodle_text_filter', 'filter_syntaxhighlighter_base_text_filter');
}
 ...
 */
class text_filter extends \filter_syntaxhighlighter_base_text_filter {
    /**
